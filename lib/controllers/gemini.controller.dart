...
class GeminiController {
  static const String apiKey = 'AIzaSyDTYKEEx6eJYBnlU6szz-KbQ3kUt1RaFNU';
  ...
  Future<String?> chat(String message) async {
    ...
    final chat = model.startChat(
      history: [
        Content.text(
            'You are a english teacher. Your responsability is talk with a student, anserwing questions. Any problema with gramatical, vocabulary or english rules must be returned to the student too.'),
        Content.model([
          TextPart(
              'Hi, I will be your english teacher. What about we will talk?')
        ])
      ],
